      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeInWhenVisible>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">I have 6 years field and technical experience and 8 years software development experience for a leading market research company building web apps and research and analytics tools</p>
